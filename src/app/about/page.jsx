        ...
        <>
            <div className={styles.myabout} dir="rtl">
                ...
                <p>
                    ...
                    فرانت اند Javascript مثل reactjs و nextjs و همچنین apiنویسی
                    سمت سرور که با nodejs و express پیاده سازی میشه...تجربه کار
                    با دیتابیس های mysql و mongodb در زبان جاوااسکریپت...آشنا با
                    معماری mvc...تا حدودی کدنویسی شی گرا..دارای سابقه کار با
                    سیستم مدیریت محتوای وردپرس و تجربه کار با فوتوشاپ(در حد
                    تراکت)
                </p>
            </div>
