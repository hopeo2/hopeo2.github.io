    ...
    return (
        <>
            <div className={styles.myabout} dir="rtl">
                <h1>درباره من</h1>
                <p>
                    سلام..امید عبیدزاده هستم توسعه دهنده نرم افزار با سابقه
                    حدودا یک سال کار در زمینه برنامه نویسی که با html,css شروع
                    کردم... با کتابخونه ها و فریمورک‌های فرانت اند Javascript
                    مثل reactjs و nextjs و همچنین apiنویسی سمت سرور که با nodejs
                    و express پیاده سازی میشه آشنا شدم...سعادت اسنفاده از
                    دیتابیس های mysql و mongodb در زبان جاوااسکریپت رو پیدا
                    کردم...با معماری mvc آشنا شدم و تا حدودی شی گرا کد زدم..ولی
                    اولین سابقه کارم خب با سیستم مدیریت محتوای وردپرس بود که به
                    واسطه ش با فوتوشاپ(در حد تراکت) هم کار کردم...
                </p>
            </div>
